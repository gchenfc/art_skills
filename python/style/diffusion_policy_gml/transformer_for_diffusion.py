# From Diffusion Policy: https://github.com/real-stanford/diffusion_policy/blob/main/diffusion_policy/model/diffusion/transformer_for_diffusion.py
...
class TransformerForDiffusion(ModuleAttrMixin):
    ...
    def __init__(self,
        ...
        if T_cond > 0:
            ...
            if n_cond_layers > 0:
                encoder_layer = nn.TransformerEncoderLayer(d_model=n_emb,
                                                           nhead=n_head,
                                                           dim_feedforward=4 *
                                                           n_emb,
                                                           dropout=p_drop_attn,
                ...
                self.encoder = nn.Sequential(nn.Linear(n_emb, 4 * n_emb),
                                             nn.Mish(),
    ...
    def _init_weights(self, module):
        ignore_types = (nn.Dropout, SinusoidalPosEmb,
    ...
    def get_optim_groups(self, weight_decay: float = 1e-3):
        ...
        if "pos_emb" in self._parameters:
